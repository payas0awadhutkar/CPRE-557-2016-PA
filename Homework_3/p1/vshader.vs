...
// Code to use light is taken from multi_vertex_lights.vs
// I defined no. of light sources (maximum) to be 8 while declaring array lights of struct Light
// Rest of the code worked fine as it is
