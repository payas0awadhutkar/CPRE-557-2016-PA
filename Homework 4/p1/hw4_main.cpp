...
// TODOs completed by Payas Awadhutkar
...
void createSquare(void)
{
	...
	float *texture_coordinates = new float[12];
	...
	// texture coordinates added below

	texture_coordinates[0] = 0.0; texture_coordinates[1] = 0.0;	
	texture_coordinates[2] = 0.0; texture_coordinates[3] = 1.0;
	texture_coordinates[4] = 1.0; texture_coordinates[5] = 1.0;
	texture_coordinates[6] = 1.0; texture_coordinates[7] = 0.0;
	texture_coordinates[8] = 0.0; texture_coordinates[9] = 0.0;
	texture_coordinates[10] = 1.0; texture_coordinates[11] = 1.0;
	...
	// loading texture and object

	unsigned char* flag = ImgLoader().Load("grand_canyon.bmp");
	GLuint texture;
